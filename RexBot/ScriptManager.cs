    ...
    public static class ScriptManager
    {
        public static async Task<object> ExecuteScript(string code, SocketMessage message = null)
        {
            var op = ScriptOptions.Default
                                  ...
                                  .WithReferences(typeof(List<>).Assembly, typeof(Enumerable).Assembly, typeof(string).Assembly, typeof(RexBotCore).Assembly)
                                  .WithImports("System", "System.Collections.Generic", "System.Timers", "System.Linq", "RexBot");
